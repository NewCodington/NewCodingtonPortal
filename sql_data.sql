...
INSERT INTO codington.event(Name, Description, Place, Date_event, StartTime, Duration , Event_type, Seats_available) VALUES ('Boston Americans vs Chicago White Sox', 'American League of Baseball match.', 22, '2014-12-22', '10.30 PM', '190 min', 'Baseball', 56000 );
INSERT INTO codington.event(Name, Description, Place, Date_event, StartTime, Duration , Event_type, Seats_available) VALUES ('Zoo Guided Tour', 'Zoo Guided tour to see the different animals.', 26, '2014-12-22', '12.30 PM', '100 min', 'Zoo Animals', 254 );
INSERT INTO codington.event(Name, Description, Place, Date_event, StartTime, Duration , Event_type, Seats_available) VALUES ('Festival Park', 'Celebration for handicapped children.', 27, '2014-12-22', '16.30 PM', '50 min', 'Festival', 560 );
...
INSERT INTO codington.event(Name, Description, Place, Date_event, StartTime, Duration , Event_type, Seats_available) VALUES ('Medieval Market', 'Sale products of medieval times.', 32, '2014-12-22', '10.30 AM', '150 min', 'Market', 2102 );